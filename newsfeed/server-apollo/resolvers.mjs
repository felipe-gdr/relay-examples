...
export const topStoryResolver = (_, {category}) => makeItSlow(() => {
...
export const topStoriesResolver = () => makeItSlow(() => {
...
export const resolveViewer = () => makeItSlow(() => {
    return {
        actor: nodes.find((node) => node.id === "the-viewer"),
    };
}, 2000)

export function resolveNode(_,args) {
